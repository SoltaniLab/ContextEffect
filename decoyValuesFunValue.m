function decoyMatrix = decoyValuesFunValue(decoyTypeRand,magProbVector,trialNumber)
% -------------------------------------------------------------------------
...
for i = 1 : trialNumber 
    ...
    %   What decoy type they are dominand 1 or dominated 2
    decoyType                =   (1*(decoyTypeRand(i,1)==1)+2*(decoyTypeRand(i,1)==2)+1*(decoyTypeRand(i,1)==3)+2*(decoyTypeRand(i,1)==4));
    ...
    decoyOf                  =   (1*(decoyTypeRand(i,1)==3)+1*(decoyTypeRand(i,1)==4)+3*(decoyTypeRand(i,1)==1)+3*(decoyTypeRand(i,1)==2));
